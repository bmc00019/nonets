...
<body id="mobile" data-type="background" data-speed="15">
<div id="overlay"></div>
<div id="main_background" data-speed="16" data-type="background">
			<div id="spacer">
				<header>
					<div id="lockup">
						<h1>
			...
			<div id="content">
				...
				<div id="video_container_outer">
					<div id="video_container">
						<iframe width="100%" height="100%" src="//www.youtube.com/embed/uMtz1xobvn4?autoplay=0&amp;controls=2&amp;rel=0&amp;vq=large&amp;showinfo=0&amp;iv_load_policy=0" frameborder="0" allowfullscreen></iframe>
					</div>
				</div>
				<div id="socials">
					<ul>
...
<script type="text/javascript" src="assets/js/script_mobile_1227.js"></script>
<!-- analytics -->
 <script>
